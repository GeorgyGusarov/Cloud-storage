...
public class FileCopy {
    public static void main(String[] args) {
        File file = new File("C:\\Programming\\Cloud storage\\cloud-server\\src\\main\\java\\netty_examples\\dir1\\pepe.jpg");
        String name = file.getName();

        File fileCopy = new File("C:\\Programming\\Cloud storage\\cloud-server\\src\\main\\java\\netty_examples\\dir2\\pepe_copy.jpg");
